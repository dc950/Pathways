...
def define_qualifications():
    print("Test")


def define_qualification_types():
    """ 1 Added """
    global gcse
    gcse.name = "GCSE"
    gcse.level = 2
...
def define_subjects():
    for subject in sorted([["English", "Literature"], ["English Language", "Linguistics"],
                    ...
                    ["Core Science", "Earth Sciences"],
                    ["Double Science", "Earth Sciences"], ["Triple Science", "Earth Sciences"],
                    ["Additional Science", "Earth Sciences"], ["Afrikaans", "Linguistics"], ["Arabic", "Linguistics"],
                    ["Bengali", "Linguistics"],
                    ["Cantonese", "Linguistics"], ["Mandarin", "Linguistics"], ["Dutch", "Linguistics"],
                    ["French", "Linguistics"], ["Applied French", "Linguistics"], ["Business French", "Linguistics"],
                    ["German", "Linguistics"], ["Applied German", "Linguistics"], ["Business German", "Linguistics"],
                    ["Modern Greek", "Linguistics"], ["Gujarati", "Linguistics"], ["Modern Hebrew", "Linguistics"],
                    ["Hindi", "Linguistics"], ["Gaeilge", "Linguistics"], ["Italian", "Linguistics"],
                    ["Japanese", "Linguistics"], ["Maltese", "Linguistics"], ["Malay", "Linguistics"],
                    ["Manx", "Linguistics"],
                    ["Punjabi", "Linguistics"], ["Persian", "Linguistics"], ["Polish", "Linguistics"],
                    ["Portuguese", "Linguistics"], ["Russian", "Linguistics"], ["Somali", "Linguistics"],
                    ["Spanish", "Linguistics"],
                    ["Tamil", "Linguistics"], ["Telugu", "Linguistics"], ["Turkish", "Linguistics"],
                    ["Urdu", "Linguistics"], ["Yoruba", "Linguistics"], ["Classical Tamil", "Linguistics"],
                    ["Classical Arabic", "Linguistics"],
                    ["Classical Greek", "Linguistics"], ["Biblical Hebrew", "Linguistics"], ["Latin", "Linguistics"],
                    ["Classical Sanskrit", "Linguistics"], ["Design & Technology", "Architecture & Design"],
                    ["Parametric CAD", "Engineering & Technology"], ["Electronic Products", "Engineering & Technology"],
                    ["Electronics", "Engineering & Technology"], ["Food Technology", "Agriculture"],
                    ["Graphic Design/Products", "Visual Arts"], ["Product Design", "Architecture & Design"],
                    ["Resistant Materials", "Engineering & Technology"], ["Textiles", "Visual Arts"],
                    ["Product Design", "Visual Arts"],
                    ["Resistant Materials", "Architecture & Design"], ["Textiles", "Visual Arts"],
                    ["Systems & Control", "Engineering & Technology"], ["Catering", "Agriculture"],
                    ["Electronics with Resistant Materials", "Engineering & Technology"],
                    ["Engineering", "Engineering & Technology"],
                    ["Engineering & Manufacturing", "Engineering & Technology"], ["Home Economics", "Agriculture"],
                    ["Food & Nutrition", "Agriculture"], ["Child Development", "Social Work"],
                    ["Textiles", "Visual Arts"], ["Manufacturing", "Engineering & Technology"],
                    ["ICT", "Computer Science"], ["Computer Science", "Computer Science"],
                    ["Computing", "Computer Science"], ["Digital technology", "Computer Science"],
                    ["Citizenship", "Anthropology"], ["Classical Civilisation", "Human History"],
                    ["Economics", "Economics"], ["Geography", "Geography"],
                    ["History", "Human History"], ["Humanities", "Anthropology"],
                    ["Religious Studies", "Religious Studies"], ["Buddhism", "Religious Studies"],
                    ["Christianity", "Religious Studies"], ["Hinduism", "Religious Studies"],
                    ["Islam", "Religious Studies"], ["Judaism", "Religious Studies"],
                    ["Philosophy & Ethics", "Philosophy"], ["Sikhism", "Religious Studies"],
                    ["Business Studies", "Business"], ["Applied Business", "Business"],
                    ["Business & Economics", "Business"], ["Business & Communications Systems", "Business"],
                    ["Financial Services", "Economics"], ["Health & Social Care", "Social Work"],
                    ["Hospitality", "Sociology"], ["Law", "Law"],
                    ["Leisure & Tourism", "Geography"], ["Psychology", "Psychology"], ["Sociology", "Sociology"],
                    ["Travel & Tourism", "Geography"], ["Animation", "Visual Arts"],
                    ["Applied Art & Design", "Visual Arts"],
                    ["Art & Design", "Visual Arts"], ["Fine Art", "Visual Arts"], ["Graphics", "Visual Arts"],
                    ["Photography", "Visual Arts"], ["Textiles", "Visual Arts"], ["3D Design", "Visual Arts"],
                    ["Dance", "Visual Arts"],
                    ["Drama", "Performing Arts"], ["Digital Photography", "Visual Arts"],
                    ["Expressive Arts", "Performing Arts"],
                    ["Film Studies", "Journalism, Media Studies & Communication"],
                    ["Media Studies", "Journalism, Media Studies & Communication"],
                    ["Moving Image Arts", "Performing Arts"], ["Music", "Performing Arts"],
                    ["Performing Arts", "Performing Arts"], ["Original Writing", "Literature"],
                    ["Accounting", "Business"],
                    ["Additional Mathematics", "Mathematics"], ["Astronomy", "Physics"],
                    ["Construction", "Architecture & Design"],
                    ["Construction & the Built Environment", "Architecture & Design"],
                    ["Environmental Science", "Environmental Studies"], ["Geology", "Geography"],
                    ["General Studies", "Sociology"],
                    ["Human Physiology & Health", "Human Physical Performance & Recreation"],
                    ["IFS Personal Finance", "Economics"], ["Journalism", "Journalism, Media Studies & Communication"],
                    ["Learning for Life & Work", "Sociology"], ["Motorsport", "Engineering & Technology"],
                    ["Motor Vehicle & Road User Studies", "Engineering & Technology"],
